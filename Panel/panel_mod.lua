...
--  first addapion made by SeaJey to conky_orange.lua, thanks for the inspiring.
...
{
    name='exec',                arg='perl ~/.conky/Panel/mem.pl',                      max_value=100,
    x=70,                          y=300,
    graph_radius=54,
    graph_thickness=10,
    graph_start_angle=180,
...
{
    name='downspeedf',           arg='vpn0',                     max_value=100,
    x=100,                          y=660,
    graph_radius=42,
    graph_thickness=7,
...
{
    name='upspeedf',           arg='vpn0',                     max_value=100,
    x=100,                          y=660,
    graph_radius=30,
    graph_thickness=7,
